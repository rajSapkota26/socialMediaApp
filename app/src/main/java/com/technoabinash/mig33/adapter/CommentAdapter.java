...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder> {
    ...
    public CommentAdapter(Context mContext, ArrayList<Comment> mComments , String postId) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.sample_comment_view, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imageProfile = itemView.findViewById(R.id.commenter_sample_user_Image);
            username = itemView.findViewById(R.id.sample_comment_userName);
            comment = itemView.findViewById(R.id.sample_comment_comment);
